...
(6, 'Player Ads', 'image', '', '{\"image\":\"player-ads.webp\",\"link\":null}', 0, 0, 2),
...
(1, 'Türkçe', 'tr', 'tr-TR', 'ltr', 'TL', 0, 1),
(2, 'English', 'en', 'en-EN', 'ltr', 'USD', 0, 0);
...
(2, 'Popular Actors', 'home.actors', '{\"sorting\":\"id desc\",\"responsive\":\"horizontal\"}', 'home', 6, 7, 1),
...
(7, 'Slider', 'home.slider', '{\"sorting\":\"id desc\"}', 'home', 3, NULL, 1),
(8, 'Stories', 'home.trailer', '{\"sorting\":\"id desc\",\"responsive\":\"horizontal\"}', 'home', 6, 1, 1);
